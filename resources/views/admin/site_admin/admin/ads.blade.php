                            ...
                            <div class="row">
                                <div class="col-sm-4 imgUp">
                                    ...
                                    <label class="btn btn-primary upload_btn">
                                        Upload<input type="file" accept="image/png,image/jpeg,image/jpg" onchange="displaySelectedPhoto('upload_photo','image')" id="upload_photo" class="uploadFile img" value="Upload Photo" style="width: 0px;height: 0px;overflow: hidden;">
                                    </label>
                                </div>
                                <div class="col-sm-8">
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="update_link" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="update_s_date">Start Date</label>
                                               <input type="date" id="update_s_date" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="update_e_date">End Date</label>
                                                <input type="date" id="update_e_date" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <label for="text
                                            ...
                                            <div class="row">
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input webpage_arr">
                                                            <label class="custom-control-label" for="">Home</label>
                                                            </div>

                                                            <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input webpage_arr">
                                                            <label class="custom-control-label" for="">News</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                            </div>
